var reqs = [
  require('./auth_switch_request.js'),
  require('./auth_switch_response.js'),
  require('./auth_switch_request_more_data.js'),
  require('./binlog_dump.js'),
  require('./register_slave.js'),
  require('./ssl_request.js'),
  require('./handshake.js'),
  require('./handshake_response.js'),
  require('./query.js'),
  require('./resultset_header.js'),
  require('./column_definition.js'),
  require('./text_row.js'),
  require('./binary_row.js'),
  require('./prepare_statement.js'),
  require('./close_statement.js'),
  require('./prepared_statement_header.js'),
  require('./execute.js'),
